...
export default function LoginSignupPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Side */}
      <div className="w-1/2 bg-indigo-600 p-12 flex flex-col relative">
        <div 
      ...
      <div className="w-1/2 bg-white p-8 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          <div className="flex mb-8">
            <button 
              className={`w-1/2 py-3 px-4 text-center font-medium ${isLogin ? 'bg-indigo-600 text-white rounded-md' : 'text-gray-600'}`}
